...
const Earnings = () => {
  return (
    <section style={{ backgroundColor: '#222', padding: '20px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', color: 'white' }}>
      ...
      <div style={{ flex: '2' }}>
        <h2 style={{ float: 'left' }}>YKTV Earnings</h2>
        <table style={{ width: '100%', borderCollapse: 'collapse', color: 'white', border: '1px solid white' }}>
          <thead>
            <tr>
              <th style={{ border: '1px solid white' }}> </th>
              <th style={{ border: '1px solid white' }}>Subscription</th>
              <th style={{ border: '1px solid white' }}>Merch</th>
              <th style={{ border: '1px solid white' }}>Sponsors</th>
            </tr>
          </thead>
          <tbody>
            <tr>
